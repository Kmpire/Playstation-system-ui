...
import type { GameConsole, MenuItem, Category } from '../../../types';
...
export default function AddToTabModal({
  ...
  const filteredItems = menuItems.filter((i) => !selectedCat || i.category === selectedCat);
  ...
  return (
    <Modal
      ...
      subtitle={isRTL ? 'اختر المشروب أو الصنف المطلوب' : 'Select drink or snack item'}
