...
import type { Screen, Language, Theme, UserRole, MenuItem } from '../types';
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          {lowStockCount > 0 && (
            <button
              ...
              title={isRTL ? 'عرض قائمة النواقص في المخزون' : 'View low stock alert list'}
          ...
          >
            ...
            <span className="font-bold text-xs">{lang === 'en' ? 'عربي' : 'EN'}</span>
          </button>
      ...
      <Modal
        ...
        subtitle={isRTL ? 'الأصناف التي وصلت أو قاربت على النفاد' : 'Items that reached reorder threshold'}
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">
                    {isRTL ? `حد إعادة الطلب: ${item.lowStockThreshold}` : `Threshold: ${item.lowStockThreshold}`}
                  </div>
                </div>
