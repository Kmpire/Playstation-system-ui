      ...
      <div className="bg-white dark:bg-[#1a1d26] border-b border-slate-200 dark:border-slate-700/50 px-4 sm:px-6 py-4 flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-500 text-sm">
            {isRTL ? "المستهلكات والأجهزة" : "Consumables & physical assets"}
          </p>
        </div>
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {low ? (
                            <span className="text-xs bg-amber-100 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 px-2 py-0.5 rounded-full">
                              {isRTL ? "منخفض" : "Low Stock"}
                            </span>
                          ) : (
                            <span className="text-xs bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800/40 px-2 py-0.5 rounded-full">
                              {isRTL ? "كافٍ" : "OK"}
                            </span>
                          )}
                        </td>
                          ...
                          {isEdit ? (
                            <div className="flex gap-1">
                              ...
                              <button
                                ...
                                className="px-3 py-1 border border-slate-200 dark:border-slate-700/50 text-slate-500 dark:text-slate-500 text-xs rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                              >
                                {isRTL ? "إلغاء" : "Cancel"}
                              </button>
                            </div>
                      ...
                      <td className="px-4 py-3">
                        ...
                        >
                          {isRTL
                            ...
                            : con.status.charAt(0).toUpperCase() +
                              con.status.slice(1)}
                        </span>
                      </td>
