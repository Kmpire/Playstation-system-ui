...
export default function Card({
  ...
  const variantClasses = {
    default:
      "bg-white dark:bg-[#0f131d] border border-slate-200 dark:border-slate-800/80",
    glass:
      "bg-white/80 dark:bg-[#0f131d]/85 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80",
    elevated:
      "bg-white dark:bg-[#141926] shadow-xl border border-slate-200 dark:border-slate-800",
  }
