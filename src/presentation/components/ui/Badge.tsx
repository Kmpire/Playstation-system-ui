...
export default function Badge({
  ...
  const variantConfig: Record<BadgeVariant, { badge: string; dot: string }> = {
    ...
    occupied: {
      badge:
        "bg-[#0070d1]/15 text-[#0070d1] dark:text-sky-400 border-[#0070d1]/30",
    ...
    default: {
      badge:
        "bg-slate-200/70 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border-slate-300 dark:border-slate-700",
      dot: "bg-slate-400",
    },
  }
