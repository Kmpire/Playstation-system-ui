...
export const seedConsoles: GameConsole[] = [
  {
    id: 1,
    name: "PS5 — 01",
    type: "PS5",
    ...
    session: {
      ...
      priceSegments: [
        { playerType: "single", startElapsedMs: 0, ratePerHour: 4 },
      ],
...
export const seedControllers: Controller[] = [
...
export const seedShiftReports: ShiftReport[] = [
  {
    id: "sr1",
    date: "2026-09-10",
    staff: "Admin",
    ...
    expectedCash: 895.5,
    variance: -2.75,
    notes: "Slight shortage, verified receipts.",
  },
  {
    id: "sr2",
    date: "2026-09-09",
  ...
  },
  {
    ...
    expectedCash: 760,
    variance: 5.25,
    notes: "Extra change from tips jar.",
  },
  {
    id: "sr4",
    date: "2026-09-07",
...
export const seedAuditLog: AuditEntry[] = [
  ...
  },
  {
    ...
    details:
      "Shift handover submitted — Counted: $890.00, Expected: $892.75, Variance: −$2.75",
  },
]

export const seedCompanyInfo: CompanyInfo = {
  name: "PS Café Lounge",
